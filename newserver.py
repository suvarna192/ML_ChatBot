...
import os
import signal
from run import running_bot, FaqEngine
...
guided_flow['webinar enquire'] = {
    "greetings": "Welcome to Sumasoft How we may I help you?",
    "Information": "Thanks for sharing your details.",
    "Acknowledgement": "Thank you for contacting suma soft pvt. ltd."
}
...
async def echo(websocket, path):
    ...
    try:
        async for message in websocket:
            ...
            response, _class = running_bot.query(message)
...
def serve_html():
    ...
    logger.info("Serving HTML file at http://%s:%d", HOST, HTTP_PORT)
    http_server = httpd
